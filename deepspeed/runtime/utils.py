...
def see_memory_usage(message, force=True):
    ...
    print(f"  see_memory_usage  message : {message} , force : {force}")
    ...
    print(f" before see_memory_usage gc.collect() ")
    gc.collect()
    print(f" see_memory_usage gc.collect() ")
    ...
    print(f" get_accelerator().reset_peak_memory_stats() ")
